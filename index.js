...
const LaunchRequestHandler = {
  ...
  handle(handlerInput) {
    ...
    let speechText =
      "Hello, I am Sandy, virtual assistant. Let's start customer connect standup";
      
      
    let repromptText =
      "Sorry,I did not receive any input.";
  ...
  handle(handlerInput, error) {
    ...
    return handlerInput.responseBuilder
      .speak(
       ...
       .withSimpleCard("Sorry I am unable to understand")
      .getResponse();
  }
};
